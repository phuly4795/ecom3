    ...
    <div class="row mt-2">
        <div class="col-lg-12 ">
            <div class="ibox float-e-margins">
                @include('admin.dashboard.post.catalogue.components.toolbox', [
                ...
                <div class="ibox-content">
                    ...
                    @include('admin.dashboard.post.catalogue.components.filter')
                    @include('admin.dashboard.post.catalogue.components.table')

                    {{ $listPostCatalogue->links() }}
                </div>
            </div>
